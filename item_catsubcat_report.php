...
<head>
	...
	<title>LAstore | Laporan Data Produk Berdasarkan Kategori</title>
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Laporan <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child" style="display:block;">
						...
						<li class="active"><a href="item_catsubcat_report.php">Laporan Data Produk Berdasarkan Kategori</a></li>
