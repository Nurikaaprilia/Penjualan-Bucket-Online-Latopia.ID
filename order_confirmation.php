...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/png" href="../logo/logo7.png" />
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand"><img src="../logo/logo7.png" /></a>
			</div>
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-child"><a href="#"><i class="fa fa-th"></i> Laporan <i class="sidebar-fa fa fa-angle-down pull-right"></i></a>
					<ul class="sidebar-second-child">
						...
						<li><a href="item_catsubcat_report.php">Laporan Data Produk Berdasarkan Kategori</a></li>
					...
					<div class="row" style="margin-bottom: 10px;">
						<div class="col-lg-12" style="margin-bottom:40px;">
							...
							<div class="col-lg-12">
								...
								<div style="margin-top:3%;"><p>Terima kasih atas pembelian Anda di LAstore, kami senang bahwa Anda telah memilih berbelanja dengan LAstore dan kami berharap dapat melayani Anda kembali.</p></div>
							</div>
						</div>
				</div>
			</div>
